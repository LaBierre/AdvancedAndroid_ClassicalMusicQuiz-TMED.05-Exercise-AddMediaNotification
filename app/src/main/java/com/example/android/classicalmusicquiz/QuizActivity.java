...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // TODO (1): Create a method that shows a MediaStyle notification with two
    // TODO (1): actions (play/pause, skip to previous). Clicking on the notification should
    // TODO (1): launch this activity. It should take one argument that defines the state of MediaSession.
    /**
